...
import { UserUpdateOneRequiredWithoutPurchasesNestedInput } from "../inputs/UserUpdateOneRequiredWithoutPurchasesNestedInput";

@TypeGraphQL.InputType("UserPurchaseUpdateWithoutMerchInput", {})
export class UserPurchaseUpdateWithoutMerchInput {
  ...
  @TypeGraphQL.Field(_type => UserUpdateOneRequiredWithoutPurchasesNestedInput, {
    nullable: true
  })
  user?: UserUpdateOneRequiredWithoutPurchasesNestedInput | undefined;
}
